...
Below are sample visual outputs generated by the automation pipeline:

### Headcount Trend

![Headcount Trend](output/headcount_trend.png)

### Hiring Activity vs Turnover Rate

![Hiring Activity vs Turnover Rate](output/hiring_turnover_trend.png)

### Departmental Breakdown (Headcount + Turnover)

![Departmental Breakdown](output/department_breakdown.png)
